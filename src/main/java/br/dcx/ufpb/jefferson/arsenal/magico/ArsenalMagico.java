...
public interface ArsenalMagico {
    void cadastrarMagia(Integer id, String nome, TipoElementar tipo,FormaElementar forma, EfeitoElementar efeito, Double dano, int custoDeMana) throws MagiaJaExisteException;
